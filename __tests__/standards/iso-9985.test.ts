...
describe("ISO 9985:1996 standard", () => {
  ...
  describe("full Armenian word transliterations", () => {
    test.each([
      ...
      ["\u0561\u0572\u057B\u056B\u056F", "ag\u0307\u01F0ik"],
      // inks (himself): ι+ν+κ(U+0584→kʿ=k+U+02BF)+ε(U+0568→ë=U+00EB)
      ["\u056B\u0576\u0584\u0568", "ink\u02BF\u00EB"],
      // karogh (can/able): κ+α+ρ+ο(mid)+ρ(U+0572→ġ=g+U+0307)
      ["\u056F\u0561\u0580\u0578\u0572", "karog\u0307"],
      ...
      ["\u0569\u0565", "t\u02BFe"],
      // voch (not/no): ο→o (no vo, ISO)+χ(U+0579→č=U+010D)
      ["\u0578\u0579", "o\u010D"],
      // yes (I): ε→e (no word-initial rule in ISO)+ς
      ["\u0565\u057D", "es"],
    ])('"%s" → "%s"', (armenian, expected) => {
      expect(t(armenian)).toBe(expected);
    });
